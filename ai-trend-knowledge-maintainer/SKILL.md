...
1. 读取 `README.md`、`metadata/automation-plan.json`、`metadata/taxonomy.json`、`metadata/sources.json`、`metadata/direction-registry.json`、`metadata/source-registry.json` 和相关目标文档。
